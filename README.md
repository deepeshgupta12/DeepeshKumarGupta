...
| [**agentic-rag-verified-citations**](https://github.com/deepeshgupta12/agentic-rag-verified-citations) | Agentic RAG that verifies every citation against source text before answering, and abstains when the evidence does not hold. Self-correcting retrieval loop, deterministic citation grounding, prompt-injection defence. |
